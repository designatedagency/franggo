...
export const CTA: FC<{
    ...
    return (
        <div {...filteredProps} style={{ background:  `linear-gradient(rgba(255,255,255,0.8), rgba(255,255,255,0.8)), url('/tiles.svg')` }} className={createClassName(props, "flex justify-center bg-repeat-x bg-cover  bg-top")}>
