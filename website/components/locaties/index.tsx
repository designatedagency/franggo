...
export const Locaties: FC<React.HtmlHTMLAttributes<HTMLDivElement>> = (props) => {
    return (
        <div className={createClassName(props, "flex flex-col items-center justify-center bg-franggo-orange relative")}>
                    ...
                    <div className="flex flex-col gap-8">
                        ...
                        <div className="flex flex-col gap-4">
                            ...
                            <div className="flex flex-row w-full justify-between items-center">
                                <h3 className="font-medium">Locatie naam</h3>
