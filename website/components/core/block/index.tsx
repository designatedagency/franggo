...
export const Block: FC<{
    ...
    return <div {...filteredProps} className={createClassName(props, "relative")}>
        <div className={`absolute h-full object-cover w-[60px] z-10 top-0 left-0 hidden md:block bg-contain ${small ? "bg-[url('/block/left-small.svg')]" : "bg-[url('/sides.png')]"} bg-repeat-y`} />
        ...
        <div className={`absolute h-full object-cover w-[60px] z-10 top-0 right-0 hidden md:block bg-contain ${small ? "bg-[url('/block/right-small.svg')]" : "bg-[url('/sides.png')]"}  bg-repeat-y`} />
